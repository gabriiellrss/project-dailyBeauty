<header>
  <style>
    ...
    #btn-ico {
      opacity: 0;
      max-width: 0;
      transition: opacity 0.3s ease, max-width 1s ease;
      display: inline-block;
      overflow: hidden; 
    }

    #btn-watsapp:hover #btn-ico {
      opacity: 1;
      max-width: 200px; 
    }
  ...
  <nav class="nav justify-content-between z-3 navbar-expand-lg " id="navbar">
    ...
    <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
      <ul class="navbar-nav column-gap-lg-3 ">
        <li class="nav-item">
          <a type="button" class="btn rounded-5 text-center p-0 text-white" href="#">
            Home
          </a> 
        </li>
        <li class="nav-item">
          <a type="button" class="btn rounded-5 text-center p-0 text-white" href="#quemdenos">
            Quem nós somos
          </a>        
        </li>
        <li class="nav-item">
          <a type="button" class="btn rounded-5 text-center p-0 text-white  " href="produtos.php">
            Produtos
          </a> 
        </li>
        <li class="nav-item d-flex justify-content-center align-items-center">
          <a id="btn-watsapp" type="button" class="btn rounded-5 text-center text-white d-flex justify-content-center gap-1  p-0">
            ...
            <span class="text-center">Entre em contato</span>
          </a>
        </li>
